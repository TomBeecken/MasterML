...
# Hardware options
N_CORES: int = 3  # max number of CPU cores to use
...
# min number of times a bigram needs to appear in the corpus to be considered as a phrase
...
Path(OUTPUT_FOLDER, "scores", "word_contributions").mkdir(
